      ...
      <div className="border-t border-gray-100 px-3 py-2 flex justify-between items-center">
        {canMoveBack ? (
          <button
            ...
            className="text-xs text-[#1e293b] hover:text-black hover:bg-gray-100 flex items-center gap-1 px-2 py-1 rounded-lg transition-all active:scale-95"
          >
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center justify-between">
            ...
            <button onClick={onClose} className="text-[#1e293b] hover:text-black transition p-1">
            ...
            if (editingId === stage.id) {
              return (
                <div key={stage.id} className="flex items-center gap-2 p-3 bg-gray-50 rounded-xl border-2 border-[#00d4ff]">
                  ...
                  <button onClick={() => setEditingId(null)} className="text-[#1e293b] hover:text-black text-sm px-2">
                    Annulla
                  </button>
                </div>
              );
              ...
              <div key={stage.id} className="flex items-center gap-2 p-3 bg-white rounded-xl border border-gray-200 hover:border-gray-300 transition group">
                ...
                <div className="flex flex-col gap-0.5">
                  <button
                    ...
                    disabled={idx === 0}
                    className="text-[#1e293b] hover:text-black disabled:opacity-20 transition"
                  >
        ...
        <div className="p-6 border-t border-gray-100 flex justify-end gap-3">
          <button
            onClick={onClose}
            className="px-5 py-2 rounded-full text-sm font-medium text-[#1e293b] hover:text-black transition"
          >
            Annulla
          </button>
          <button
