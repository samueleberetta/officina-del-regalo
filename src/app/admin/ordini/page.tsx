      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium text-[#1e293b] bg-white border border-gray-200 hover:border-[#00d4ff] hover:text-[#00d4ff] transition shadow-sm"
          >
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-bold text-[#1e293b] text-sm">{stage.nome}</h3>
                  </div>
    ...
    >
      ...
      >
        <div className="border-t border-gray-100 px-4 py-3 space-y-3">
          <div>
            <p className="text-xs font-bold text-[#1e293b] mb-1">Prodotti</p>
          ...
          <div>
            <p className="text-xs font-bold text-[#1e293b] mb-1">Spedizione</p>
      ...
      <div className="border-t border-gray-100 px-3 py-2 flex justify-between items-center">
        {canMoveBack ? (
          <button
            ...
            className="text-xs text-[#1e293b] hover:text-[#e2e8f0] hover:bg-gray-100 flex items-center gap-1 px-2 py-1 rounded-lg transition-all active:scale-95"
          >
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-100">
          <div className="flex items-center justify-between">
            <h2 className="font-heading text-xl text-[#1e293b]">Modifica sezioni pipeline</h2>
            <button onClick={onClose} className="text-[#1e293b] hover:text-[#e2e8f0] transition p-1">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
              </svg>
            </button>
          </div>
          <p className="text-sm text-[#1e293b] mt-1">Gestisci le colonne della vista Kanban</p>
        </div>
            ...
            if (editingId === stage.id) {
              return (
                <div key={stage.id} className="flex items-center gap-2 p-3 bg-gray-50 rounded-xl border-2 border-[#00d4ff]">
                  ...
                  <button onClick={() => setEditingId(null)} className="text-[#1e293b] hover:text-[#e2e8f0] text-sm px-2">
                    Annulla
                  </button>
                </div>
              );
              ...
              <div key={stage.id} className="flex items-center gap-2 p-3 bg-white rounded-xl border border-gray-200 hover:border-gray-300 transition group">
                ...
                <div className="flex flex-col gap-0.5">
                  <button
                    ...
                    disabled={idx === 0}
                    className="text-[#1e293b] hover:text-[#e2e8f0] disabled:opacity-20 transition"
                  >
                ...
                <span className="flex-1 text-sm font-medium text-[#1e293b]">{stage.nome}</span>

                {/* Actions */}
                <button
                  onClick={() => startEditing(stage)}
                  className="text-[#1e293b] hover:text-[#00d4ff] opacity-0 group-hover:opacity-100 transition text-xs font-medium"
                >
                  Modifica
                </button>
                <button
        ...
        <div className="px-6 pb-4">
          <p className="text-xs font-bold text-[#1e293b] mb-2">Aggiungi nuova sezione</p>
          <div className="flex items-center gap-2">
            <input
              type="text"
              value={newName}
        ...
        <div className="p-6 border-t border-gray-100 flex justify-end gap-3">
          <button
            onClick={onClose}
            className="px-5 py-2 rounded-full text-sm font-medium text-[#1e293b] hover:text-[#e2e8f0] transition"
          >
            Annulla
          </button>
          <button
